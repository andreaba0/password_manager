...
export default function App() {
    ...
    const [activeSharedType, setActiveSharedType] = useState<string | null>(
        null,
    );
    ...
    const listItems = activeVaultId
        ? activeSharedType
            ? allVaultItems.filter((i) => i.type === activeSharedType)
            : allVaultItems
    ...
    const mobileBackLabel = showingInvites
        ? "Pending Invites"
        : rightPanel === "settings"
